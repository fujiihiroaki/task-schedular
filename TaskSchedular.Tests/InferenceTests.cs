...
/// <summary>
///     Inferenceクラスのユニットテスト
/// </summary>
public class InferenceTests {
    [Fact]
    public void ApplyAutoStart_StartAlreadySet_DoesNotOverwrite()
    {
        // Arrange
        ...
        // Assert
        Assert.Equal(new DateTime(2026, 2, 1), task.Start);
    }

    [Fact]
    public void ApplyAutoStart_NoDueDate_DoesNotSetStart()
    {
        // Arrange
        var task = new TaskItem
        {
    ...
    [Fact]
    public void ApplyAutoStart_ExamTag_Sets90DaysLead()
    {
        // Arrange
        var due = new DateTime(2026, 6, 1);
        var task = new TaskItem
    ...
    [Fact]
    public void ApplyAutoStart_CertTag_Sets90DaysLead()
    {
        // Arrange
        var due = new DateTime(2026, 6, 1);
        var task = new TaskItem
    ...
    [Fact]
    public void ApplyAutoStart_TaxTag_Sets30DaysLead()
    {
        // Arrange
    ...
    [Fact]
    public void ApplyAutoStart_TravelTag_Sets14DaysLead()
    {
        // Arrange
    ...
    [Fact]
    public void ApplyAutoStart_ExamKeywordInTitle_Sets90DaysLead()
    {
        // Arrange
        var due = new DateTime(2026, 6, 1);
        var task = new TaskItem
    ...
    [Fact]
    public void ApplyAutoStart_TaxKeywordInTitle_Sets30DaysLead()
    {
        // Arrange
        var due = new DateTime(2026, 3, 15);
        var task = new TaskItem
    ...
    [Fact]
    public void ApplyAutoStart_ExplicitLead_UsesExplicitLead()
    {
        // Arrange
        var due = new DateTime(2026, 6, 1);
        var task = new TaskItem
    ...
    [Fact]
    public void ApplyAutoStart_PaceOverridesLead_UsesPaceLead()
    {
        // Arrange
        var due = new DateTime(2026, 6, 1);
        var task = new TaskItem
